...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => new { e.BookingReservationId, e.RoomId }).HasName("PK__BookingD__219A5D2EA8FC3C57");
        ...
        {
            entity.HasKey(e => e.BookingReservationId).HasName("PK__BookingR__A2B23EBF4D4B8510");
        ...
        {
            entity.HasKey(e => e.CustomerId).HasName("PK__Customer__A4AE64B8AD75A0F5");
        ...
        {
            entity.HasKey(e => e.RoomId).HasName("PK__RoomInfo__3286391916565BAE");
        ...
        {
            entity.HasKey(e => e.RoomTypeId).HasName("PK__RoomType__BCC89611EF4B7346");
